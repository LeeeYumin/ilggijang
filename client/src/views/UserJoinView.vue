          ...
          <div class="col-md-12 col-lg-6 col-xl-7">
            ...
            <div class="form-item col-lg-6 my-3">
              ...
              <input
                ...
                placeholder="비밀번호 입력"
                id="pw_no_confirm"
                v-model="userInfo.pw_no_confirm"
              />
            </div>
            <div class="form-item col-lg-6 my-3">
            ...
            <div class="row">
              <div class="col-md-12 col-lg-6">
                <div class="form-item w-100">
                  ...
                  <input
                    type="text"
                    class="form-control"
                    placeholder="생년월일 8자리 (예시 : 19000101)"
                    id="birth_date"
              ...
              <div class="col-md-12 col-lg-6">
                <div class="form-item w-100">
                  ...
                  <input type="radio" class="btn-check" name="gender" id="btnradio1" autocomplete="off" value="m1" v-model="userInfo.gender_code"/>        
                 
                  <label class="btn btn-outline-primary margin-right" for="btnradio1">남</label>
                   <input type="radio" class="btn-check" name="gender" id="btnradio2" autocomplete="off" value="m2" v-model="userInfo.gender_code"/>
              ...
              <div class="col-md-12 col-lg-6">
                <div class="form-item w-100">
                  <label class="bold">연령대<sup></sup></label><br />
                  <input type="radio" class="btn-check" name="age" id="btnradio3" autocomplete="off" value="z1" v-model="userInfo.age_code"/>        
                  <label class="btn btn-outline-primary margin-right" for="btnradio3">10대</label>
                   <input type="radio" class="btn-check" name="age" id="btnradio4" autocomplete="off" value="z2" v-model="userInfo.age_code"/>
                    <label class="btn btn-outline-primary margin-right" for="btnradio4">20대</label >
                    <input type="radio" class="btn-check" name="age" id="btnradio5" autocomplete="off" value="z3" v-model="userInfo.age_code"/>
                    <label class="btn btn-outline-primary margin-right" for="btnradio5">30대</label >
                     <input type="radio" class="btn-check" name="age" id="btnradio6" autocomplete="off" value="z4" v-model="userInfo.age_code"/>
                    <label class="btn btn-outline-primary margin-right" for="btnradio6">40대</label >
                     <input type="radio" class="btn-check" name="age" id="btnradio7" autocomplete="off" value="z5" v-model="userInfo.age_code"/>
                    <label class="btn btn-outline-primary margin-right" for="btnradio7">50대</label >
                     <input type="radio" class="btn-check" name="age" id="btnradio8" autocomplete="off" value="z6" v-model="userInfo.age_code"/>
                    <label class="btn btn-outline-primary margin-right" for="btnradio8">60대</label >
                </div>
              </div>
              </div>
            </div>
    ...
    async userInsert() {
      ...
      let data = {
        ...
        //   member_type: this.userInfo.type,
          ...
          age_code: this.userInfo.age_code
        },
      };
