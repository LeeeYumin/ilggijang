<template>
  <div class="top_con">
    <div class="container">
      ...
      <div class="tR"><p><span class="point">뭐뭐</span>님, 오늘도 좋은하루 보내세요 <font-awesome-icon icon="fa-solid fa-face-laugh-wink" size="lg" style="color:#fff;"/></p></div>
    </div>
  </div>
    ...
    <div class="content">
      <div class="list">
        <ul>
          ...
          <li><div><p>내리뷰</p><p class="ico"><font-awesome-icon icon="fa-solid fa-pencil" size="2xl" /></p></div></li>
          <li><div><p>찜</p><p class="ico"><font-awesome-icon :icon="['far', 'thumbs-up']" size="2xl" /></p></div></li>
          <li><div><p>1:1문의</p><p class="ico"><font-awesome-icon :icon="['far', 'comments']" size="2xl" /></p></div></li>
          <li><div><p>내주문내역</p><p class="ico"><font-awesome-icon :icon="['fas', 'list']" size="2xl" /></p></div></li>
          <li><div><p>회원탈퇴</p><p class="ico"><font-awesome-icon :icon="['fas', 'right-to-bracket']" size="2xl" /></p></div></li>
        </ul>
      </div>
    </div>
  </div>
...
.list ul{list-style:none; display:flex; justify-content:space-between; gap:1%; flex-flow:wrap;}
