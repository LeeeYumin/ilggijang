    ...
    <div class="content">
      <div class="list">
        <ul>
          ...
          <li><div><p>내주문내역</p><p class="ico"><font-awesome-icon :icon="['fas', 'list']" size="2xl" style="color:#303d8f;" /></p></div></li>
...
.content{position:relative; margin-bottom:50px; min-height:400px;}
